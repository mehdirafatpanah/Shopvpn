...
# Admin panel category headers and menu item labels (keyboards.py:
# ADMIN_PANEL_CATEGORIES / ADMIN_PANEL_ITEMS / _EXTRA_PANEL_ITEM_LABELS).
# These default labels are shown to the admin as inline-keyboard buttons and
# were previously never routed through tr(), so they stayed in Persian no
# matter the admin's chosen language. Registering the English source here is
# what lets the lazy AI-translation path (translation_engine) generate them
# for every other active language on first use.
_PHRASE_TRANSLATIONS.update({
    # category headers
    "📋 کارهای روزانه": "📋 Daily tasks",
    "📦 محصولات و کانفیگ": "📦 Products & configs",
    "🤝 نمایندگی‌ها": "🤝 Resellers",
    "🎯 بازاریابی و رشد": "🎯 Marketing & growth",
    "💰 مالی و پرداخت": "💰 Finance & payments",
    "🔔 یادآوری‌ها و هشدارها": "🔔 Reminders & alerts",
    "👤 ادمین و دسترسی": "👤 Admin & access",
    "🎨 ظاهر و رنگ‌بندی": "🎨 Appearance & colors",
    "📊 گزارش و سیستم": "📊 Reports & system",
    # extra (non-item) panel entries
    ...
    "🧹 پاکسازی خودکار منقضی‌ها": "🧹 Auto-cleanup of expired items",
    "📢 عضویت اجباری در کانال": "📢 Mandatory channel membership",
    "📣 کانال اعلان حذف/اتمام کانفیگ": "📣 Config removal/expiry alert channel",
    "🧾 سفارش‌های در انتظار": "🧾 Pending orders",
    "🗳 نظرسنجی سفارش‌ها": "🗳 Order surveys",
    "🎫 تیکت‌های پشتیبانی": "🎫 Support tickets",
    "🧩 دپارتمان‌های پشتیبانی": "🧩 Support departments",
    "👛 درخواست‌های شارژ کیف پول": "👛 Wallet top-up requests",
    "🪙 پرداخت‌های کریپتو": "🪙 Crypto payments",
    "💳 پرداخت‌های آبان گیت وی": "💳 AbanGateway payments",
    "💳 پرداخت‌های بلوپال": "💳 BluPal payments",
    "⭐ پرداخت‌های NoapayBot": "⭐ NoapayBot payments",
    "🎟 مدیریت کدهای تخفیف": "🎟 Manage discount codes",
    "🎡 مدیریت گردونه شانس": "🎡 Manage lucky wheel",
    "🪙 سکه و قرعه‌کشی شبانه": "🪙 Coins & nightly lottery",
    "💸 کش‌بک تمدید و شارژ": "💸 Renewal & top-up cashback",
    "🔔 یادآوری تمدید سرویس": "🔔 Service renewal reminder",
    "📉 یادآوری اتمام حجم": "📉 Low-volume reminder",
    ...
    "🎁 هدیه‌ی عضویت": "🎁 Signup gift",
    "🏪 مدیریت بات‌های نمایندگی": "🏪 Manage reseller bots",
    "💳 نمایندگی حجمی (اعتبار)": "💳 Volume (credit) reseller program",
    "💼 نمایندگی کمیسیونی": "💼 Commission reseller program",
    "⏳ هزینه و انقضای نمایندگی": "⏳ Reseller fee & expiry",
    "📋 درخواست‌های نمایندگی": "📋 Reseller requests",
    "✏️ ویرایش متن دکمه‌ها": "✏️ Edit button text",
    "🧾 تنظیمات حساب کاربری کاربران": "🧾 User account settings",
    "🧩 چیدمان/نمایش منوی اصلی": "🧩 Main menu layout/visibility",
    "💳 تنظیم شماره کارت": "💳 Set card number",
    "⏱ حذف خودکار پیام شماره کارت": "⏱ Auto-delete card number message",
    "🪙 تنظیم درگاه کریپتو (Plisio)": "🪙 Set crypto gateway (Plisio)",
    "💳 تنظیم درگاه آبان گیت وی": "💳 Set AbanGateway",
    "💳 تنظیم درگاه بلوپال": "💳 Set BluPal gateway",
    "⭐ تنظیم درگاه NoapayBot": "⭐ Set NoapayBot gateway",
    "📶 کارت‌به‌کارت با تایید خودکار (پیامک بانک)": "📶 Card-to-card with auto-confirm (bank SMS)",
    "💠 درگاه‌های پرداخت سفارشی (فعال/غیرفعال)": "💠 Custom payment gateways (on/off)",
    "🧮 حداقل مبلغ پرداخت‌ها": "🧮 Minimum payment amount",
    "👛 روش‌های پرداخت شارژ کیف پول": "👛 Wallet top-up payment methods",
    "➖ کاهش گروهی موجودی کیف پول": "➖ Bulk-deduct wallet balance",
    "➕ افزایش گروهی موجودی و اعلان": "➕ Bulk-credit wallet & notify",
    "🛠 روش‌های پرداخت کانفیگ شخصی": "🛠 Personal config payment methods",
    "📝 ویرایش پیام خوش‌آمد": "📝 Edit welcome message",
    "📚 مدیریت آموزش‌ها (عنوان، مراحل، محل نمایش)": "📚 Manage tutorials (title, steps, placement)",
    "👤 مدیریت ادمین‌ها": "👤 Manage admins",
    "📢 پیام همگانی": "📢 Broadcast message",
    "🔗 دیپ‌لینک و پست کانال": "🔗 Deep links & channel post",
    "📊 آمار فروش": "📊 Sales stats",
    "👥 مدیریت کاربران": "👥 Manage users",
    "🗄 بکاپ و بازیابی": "🗄 Backup & restore",
    "📣 گروه گزارش تاپیک‌دار": "📣 Topic-based report group",
    "🎁 هدیه‌ی گروهی": "🎁 Bulk gift",
    "🛡 ضداسپم کاربران": "🛡 Anti-spam for users",
    "🔌 سوئیچ سراسری ربات (خاموش/روشن)": "🔌 Bot global switch (on/off)",
    "⏳ پیام موقت (خودحذف‌شونده)": "⏳ Temporary (self-deleting) message",
    "📞 روش‌های ارتباط با پشتیبانی": "📞 Support contact methods",
    "🤖 دستیار هوشمند (سوالات متداول)": "🤖 AI assistant (FAQ)",
    "🌐 ترجمه خودکار": "🌐 Automatic translation",
    # per-admin language switch (new feature)
    "🌐 زبان ادمین/کاربران": "🌐 Admin/users language",
    "👤 فقط برای من (این ادمین)": "👤 Just for me (this admin)",
    "🌍 برای همه‌ی کاربران ربات": "🌍 For all bot users",
    "زبان نمایش خودت رو انتخاب کن (روی بقیه‌ی کاربران اثر نداره):": "Choose your own display language (does not affect other users):",
